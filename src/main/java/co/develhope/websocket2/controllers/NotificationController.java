...
public class NotificationController {
    ...
    public ResponseEntity<HttpStatus> sendNotificationToClient(@RequestBody MessageDTO messageDTO) {
    ...
    public MessageDTO sendMessageFromClient(@RequestBody ClientMessageDTO clientMessageDTO) {
